...
final class Main {
    ...
    */
    public static void main(String[] args) {
        ...
        final Vehicle fordFocus = new Vehicle(
            "white", "B40-C4RR0", fourConst, twoHundredEightyFourConst
        );
        ...
        final Vehicle ferrari = new Vehicle(
            "red", "VHD-35HU", 2, threeHundredTwentyConst
        );
        ...
        final Vehicle citroenAmi = new Vehicle(
            "blue", "FS-695-DQ", fiveConst, fortyFiveConst
        );
